...
exports.convertToPositions = exports.simulateDilutionEffect = exports.calculateFutureMaxSupply = exports.calculateSharePoolPercentages = void 0;
/**
 * Calculate share pool percentages for each position on each day
 */
function calculateSharePoolPercentages(positions, rewardPoolData, contractStartDate) {
    const positionProjections = new Map();
...
exports.calculateSharePoolPercentages = calculateSharePoolPercentages;
/**
...
exports.calculateFutureMaxSupply = calculateFutureMaxSupply;
/**
 * Simulate dilution effect when new positions are added
 */
function simulateDilutionEffect(existingPositions, newPositions, rewardPoolData, contractStartDate) {
    // Calculate projections before new positions
    const beforeDilution = calculateFutureMaxSupply(existingPositions, rewardPoolData, 0, // Using 0 for comparison
    contractStartDate);
    // Calculate projections after new positions are added
    const allPositions = [...existingPositions, ...newPositions];
    const afterDilution = calculateFutureMaxSupply(allPositions, rewardPoolData, 0, // Using 0 for comparison
    contractStartDate);
...
exports.simulateDilutionEffect = simulateDilutionEffect;
/**
...
exports.convertToPositions = convertToPositions;
