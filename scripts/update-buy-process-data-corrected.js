...
/**
 * Updates Buy & Process data incrementally - CORRECTED VERSION
 * 
 * This version correctly groups burns by protocol day instead of calendar date.
 * Protocol days start at 6PM UTC, not midnight.
 * 
...
const CONTRACT_START_DATE = new Date('2025-07-10T18:00:00.000Z');
    ...
    // Load existing data
    const dataPath = path.join(__dirname, '../public/data/buy-process-data-corrected.json');
